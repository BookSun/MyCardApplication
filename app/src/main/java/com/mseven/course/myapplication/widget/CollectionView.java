...
import com.mseven.course.myapplication.Utils.ListsUtils;
...
public class CollectionView extends ListView {
    ...
    public static class InventoryGroup implements Cloneable {
        ...
        public InventoryGroup(InventoryGroup copyFrom) {
            ...
            mItemTag = ListsUtils.cloneSparseArray(copyFrom.mItemTag);
            mItemCustomDataIndices = ListsUtils.cloneSparseArray(copyFrom.mItemCustomDataIndices);
        }
